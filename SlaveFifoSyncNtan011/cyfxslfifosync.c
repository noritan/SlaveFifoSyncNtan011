...
#include "consumer.cydsn/cyfxgpif2config.h"
...
CyFxSlFifoApplnInit (void)
{
    ...
    apiRetStatus = CyU3PGpifLoad (&Consumer_CyFxGpifConfig);
    if (apiRetStatus != CY_U3P_SUCCESS)
    {
    ...
    apiRetStatus = CyU3PGpifSMStart (CONSUMER_RESET, CONSUMER_ALPHA_RESET);
    if (apiRetStatus != CY_U3P_SUCCESS)
    {
